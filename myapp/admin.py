...
from.models import property_cat,property,book,property_rent,booking,customer_details,Feedback
...
class properties(admin.ModelAdmin):
    list_display=['pro_name','pro_address','pro_cat','pro_price','image']
